/*
618沸腾之夜1.58红包@wenmoux
抄自 @yangtingxiao 抽奖机脚本
活动入口：京东APP首页-瓜分18亿
更新地址：https://cdn.jsdelivr.net/gh/Wenmoux/sources/other/618night.js
已支持IOS双京东账号, Node.js支持N个京东账号
脚本兼容: QuantumultX, Surge, Loon, 小火箭，JSBox, Node.js
============Quantumultx===============
[task_local]
#沸腾之夜红包
20 8 31 5 * https://cdn.jsdelivr.net/gh/Wenmoux/sources/other/id.json, tag=618沸腾之夜红包, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "20 8 31 5 *" script-path=https://g/jd_scripts/raw/ tag=沸腾之夜红包

===============Surge=================
沸腾之夜红包 = type=cron,cronexp="20 8 31 5 *",wake-system=1,timeout=3600,script-path=https://cdn.jsdelivr.net/gh/Wenmoux/sources/other/618night.js

============小火箭=========
沸腾之夜红包 = type=cron,script-path=https://cdn.jsdelivr.net/gh/Wenmoux/sources/other/618night.js, cronexpr="20 8 * * *", timeout=3600, enable=true

 */
const $ = new Env('沸腾之夜红包');
